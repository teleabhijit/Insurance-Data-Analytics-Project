...
SQL (MySQL) – KPI calculation, aggregation, and data validation

Tableau – Interactive visual analytics dashboards

Power BI – Final executive dashboards using DAX measures
...
Policy status and claim status
...
Premium vs Claim trend

Claim status distribution

Policy status distribution

2. Policy & Customer Insights

Policy type analysis

Gender distribution

Age bucket segmentation
...
Aggregate premium and claim values

Calculate approval rates

Perform year-wise premium growth analysis
...
KPI Calculation & Validation (SQL)

Visualization Development (Excel, Tableau)

Final Executive Dashboard (Power BI)
...
Detected claim-heavy policy categories

Analyzed customer demographic policy distribution
